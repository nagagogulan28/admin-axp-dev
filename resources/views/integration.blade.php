      ...
      <div class="col-lg-3 col-sm-4">
        <div class="card">
          ...
          <div class="card-inner">
            ...
            <hr />
            <div class="content">
              <a href="/download/integration/PHP MERCHANT INTEGRATION WITH appxpay DOCUMENT.pdf">Docs</a>
              <a href="/download/integration/appxpayPHPClientKit.zip"><span>Download</span> </a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-4">
        <div class="card">
          ...
          <div class="card-inner">
            ...
            <hr />
            <div class="content">
              <a href="/download/integration/JAVA MERCHANT INTEGRATION WITH appxpay DOCUMENT.pdf">Docs</a>
              <a href="/download/integration/appxpayJavaClientApplication.zip"><span>Download</span> </a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-4">
        <div class="card">
          ...
          <div class="card-inner">
            ...
            <hr />
            <div class="content">
              <a href="/download/integration/ANDROID MERCHANT INTEGRATION WITH appxpay DOCUMENT.pdf">Docs</a>
      ...
      <div class="col-lg-3 col-sm-4">
        <div class="card">
          ...
          <div class="card-inner">
            ...
            <hr />
            <div class="content">
              <a href="/download/integration/PYTHON MERCHANT INTEGRATION WITH appxpay DOCUMENT.pdf">Docs</a>
              <a href="/download/integration/appxpayPythonClientKit.zip"><span>Download</span> </a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-4">
        <div class="card">
          ...
          <div class="card-inner">
            ...
            <hr />
            <div class="content">
              <a href="/download/integration/DOT NET MERCHANT INTEGRATION WITH appxpay DOCUMENT.pdf">Docs</a>
              <a href="/download/integration/appxpay.NETClientKit.zip"><span>Download</span> </a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-sm-4">
        <div class="card">
          ...
          <div class="card-inner">
            ...
            <hr />
            <div class="content">
              <a href="/download/integration/RUBYONRAILS MERCHANT INTEGRATION WITH appxpay DOCUMENT.pdf">Docs</a>
              <a href="/download/integration/appxpayRubyKit.zip"><span>Download</span></a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-4 col-sm-4">
          <div class="card">
            ...
            <div class="card-inner">
              ...
              <hr />
              <div class="content">
                <a href="/download/integration/WOOCOMMERCE MERCHANT INTEGRATION WITH appxpay DOCUMENT.pdf">Docs</a>
                <a href="/download/integration/woocommerce-appxpay.zip"><span>Download</span> </a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-4">
          <div class="card w-100">
            ...
            <div class="card-inner">
              ...
              <hr />
              <div class="content">
                <a href="/download/integration/WORDPRESS MERCHANT INTEGRATION WITH appxpay DOCUMENT.pdf">Docs</a>
                <a href="/download/integration/wordpress_appxpay-plugin.zip"><span>Download</span> </a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        >
          ...
          <p>
            Once registered with appxpay, we provide an payment gateway
            integration kit or you download the SDK and input key and other
            necessary details provided by appxpay
          </p>
