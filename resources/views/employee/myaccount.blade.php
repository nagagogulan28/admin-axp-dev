                                ...
                                <form action="{{route('verify-emailOTP')}}" method="POST" class="form-horizontal" role="form">                                   
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="appxpayemailOTP" id="appxpayemailOTP" class="form-control" value="" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-3 col-sm-offset-2">
                                ...
                                <form action="{{route('verify-mobileOTP')}}" method="POST" class="form-horizontal" role="form">                                   
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="appxpaymobileOTP" id="appxpaymobileOTP" class="form-control" value="" required="required">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-3 col-sm-offset-2">
