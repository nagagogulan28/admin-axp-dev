...
<div class="settlements-pages">
    ...
    <div class="row row-new justify-content-between">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-5">
            <div class="mb-3">
                <p class="title-common">Vendor Bank Information</p>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-7">
            <div class="align-items-center d-flex justify-content-end">
                ...
                <div class="mb-3">
                    <a href="#">
                        <button type="button" class="bg-btn" data-toggle="modal" data-target="#myModal">
                        ...
                        <table class="table dataTable">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Srinivasan</td>
                                    <td><img src="{{ asset('new/img/table-eye.svg')}}" alt="table-eye" data-toggle="modal" data-target="#information" style="width: 25px;cursor: pointer;"></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Srinivasan’s Bank Information</h4>
            ...
            <div class="modal-body">
                ...
                <div class="mb-4">
                    {{Form::label('name', 'Account Holder Name', array('class' => 'control-label'))}}
                    {{ Form::text('name', $name = null, array('class' => 'form-control', 'placeholder' => '')) }}
                </div>
                <div class="mb-4">
                    {{Form::label('name', 'Account Number', array('class' => 'control-label'))}}
                    {{ Form::text('name', $name = null, array('class' => 'form-control', 'placeholder' => '')) }}
                </div>
                <div class="mb-4">
                    {{Form::label('name', 'Branch', array('class' => 'control-label'))}}
                    {{ Form::text('name', $name = null, array('class' => 'form-control', 'placeholder' => '')) }}
                </div>
                <div class="mb-4">
                    {{Form::label('name', 'IFSC Code', array('class' => 'control-label'))}}
                    {{ Form::text('name', $name = null, array('class' => 'form-control', 'placeholder' => '')) }}
                </div>
            </div>
        </div>
