                ...
                <div id="supplier-expense-invoice" class="tab-pane fade in active">
                    <div class="row">
                        <div class="col-sm-12 p-0 mb-4">
                            <a href="{{route('account-payable','appxpay-XYFGXwnY')}}" class="btn btn-primary pull-right">Go Back</a>
                        </div>
                    </div>
                    @if($form == "create")
                   <div class="row">
                            ...
                            <form method="POST" class="form-horizontal" role="form" id="supplier-exp-invoice-form">
                                ...
                                <div class="row row-new">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="input" class="col-lg-4 control-label">Invoice Date:</label>
                                            <div class="col-lg-6">
                                                <div class="input-group date">
                                        ...
                                        <div class="form-group">
                                            <label for="input" class="col-lg-4 control-label">Invoice No:</label>
                                            <div class="col-lg-6">
                                ...
                                <div class="row padding-20 row-new pl-0 pr-0">
                                    <div class="col-sm-6">
