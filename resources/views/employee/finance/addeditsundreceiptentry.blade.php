@php
    ...
    $bankids = appxpayBankInfo::get_bank_option();
    $revenue_codes = CharOfAccount::get_code_options();
    $customers = appxpayCustomer::get_cust_opts();
@endphp
            ...
            <div class="panel-body">
                <div class="tab-content">
                    <div id="add-edit-sund-receipt-entry" class="tab-pane fade in active">
                        <div class="row">
                            <div class="col-sm-12">
                                <a href="{{route('finance-receivable','appxpay-yKzVIkqM')}}" class="btn btn-primary btn-sm pull-right">Back</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <form id="sund-receipt-entry-form" method="POST" role="form" class="form-horizontal">
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Sundry Receipt No:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                            <input type="text" name="sundry_rcpt_no" id="sundry_rcpt_no" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Receipt Date:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Customer Name:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Revenue Code:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Bank Name:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Receipt Mode:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Payment Amount:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                            <input type="text" name="receipt_amount" id="receipt_amount" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Remarks:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                    ...
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <div class="col-sm-3 col-sm-offset-5 col-md-offset-4 col-lg-offset-3">
                                ...
                                <form id="update-sund-receipt-form" method="POST" role="form" class="form-horizontal">
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Sundry Payment No:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                            <input type="text" name="sundry_rcpt_no" id="sundry_rcpt_no" class="form-control" value="{{$edit_data->sundry_rcpt_no}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Pay Date:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                            <div class="input-group date">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Payment Mode:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                            <select name="receipt_mode" id="receipt_mode" class="form-control">
                                                <option value="">--Select--</option>
                                                @foreach($paymodes as $paymode)
