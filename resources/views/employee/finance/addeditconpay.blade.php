                            ...
                            <div class="col-sm-12">
                                ...
                                <form id="contra-entry-form" method="POST" role="form" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Contra No:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Debit Bank Account:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Credit Bank Account:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <label for="input" class="col-xs-12 col-sm-5 col-md-4 col-lg-3 control-label">Remark:</label>
                                        <div class="col-xs-12 col-sm-5  col-md-4 col-lg-3">
