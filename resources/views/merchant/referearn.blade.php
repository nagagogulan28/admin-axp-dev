                                ...
                                <div class="col-sm-6" style="overflow:scroll">
                                    <div class="panel panel-default refer-div-height">
                                        <div class="panel-body">
                                            ...
                                            <p>
                                                <strong>appxpay Refer & Earn </strong>works same as the most of the refer and earn schemes in the market.You can earn virtual money as much as you can
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="panel panel-default">
                                                        <div class="panel-body">
                                                            <div class="col-sm-12">
                                                                <div class="col-sm-3">
                                                                    <!-- <a href="https://www.facebook.com/sharer/sharer.php?s=100&p[title]=&p[summary]=&p[url]={{urlencode('http://www.appxpay.com/')}}&p[image]={{urlencode('http://www.appxpay.com/images/final-logo.png')}}" target="_black"><i class="fa fa-facebook-official fa-lg pull-left" ></i></a> -->
                                                                    <a href="https://www.facebook.com/sharer/sharer.php?u=#" target="_black"><i class="fa fa-facebook-official fa-lg pull-left" ></i></a>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <a href="https://web.whatsapp.com/send?l=en&text=appxpayref_P7MZujDRH67eTvRj" target="_black"><i class="fa fa-whatsapp fa-lg pull-left" ></i></a>
                                                                </div>
                                                                <div class="col-sm-3">
