                                ...
                                <div class="form-right">
                                    ...
                                    <div id="dynamic_container" class="dynamic">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="info@appxpay.in" class="form-control" name="contactus_email" data-label="contact email" id="right-inp" />
                                        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="sub-footer">
                    <p>&copy; Copyright 2020 <strong>appxpay</strong>

                    | Powered by <strong>appxpay</strong></p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="form-right">
                                    ...
                                    <div id="dynamic_container" class="dynamic">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" placeholder="info@appxpay.com" class="form-control" name="contactus_email" data-label="contact email" id="right-inp" />
                                        </div>
                                        <div class="input-group mt-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text br-15"><i class="fa fa-phone-square"></i></span>
