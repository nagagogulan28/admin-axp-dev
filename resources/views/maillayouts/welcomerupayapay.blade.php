        ...
        <div>
          <div style="position: relative;top: 25px; margin:0 auto; width:100%;max-width:598px;text-align:center;background-color:#fff">
                ...
                <tr>
                  ...
                  <td style="background-color:#887aff;text-align:center;width:75px">
                    <div style="width: 130px;">
                      <img style="vertical-align:bottom;width:130px;" src="{{asset('new/img/appxpay-admin-logo.png')}}" alt="AppXpay">
                    </div>
                  </td>
            ...
            <table style="width:100%;max-width:600px;font-family:Arial;font-size:16px;color:#868686;table-layout:fixed;border: 1px solid rgb(167, 167, 167);" cellspacing="0" cellpadding="0" border="0">
             <thead>
               <th colspan="3">
                <p style="text-align:center;width:auto;background-color:#fff;padding: 40px 0;font-size: 28px;font-weight: 550;color: #061f5f;border-bottom: 1px solid rgb(167, 167, 167);margin: 0;">Welcome to appxpay</p>
                ...
                <tr>
                  ...
                  <td colspan="2">
                    <div style="float: right;padding: 5px 8px 5px 0;">
                      <a href="https://appxpay.qrcsolutionz.com/" target="_blank"><img src="{{asset('/images/appxpay-pci.png')}}" alt="appxpay-pci" width="70"></a>
