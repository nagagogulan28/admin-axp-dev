...
<div class="settlements-pages">
    <p class="title-common">Payout Wallet Fund List</p>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <p class="title-common">Wallet Fund Request Validation</p>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <form id="addpayout_fund" action="" method="POST">
...
<script>
    $(document).ready(function() {
        ...
        $("#listofServiceFund").on('click', '.add-amt-request', function() {
            ...
            $.ajax({
                url: '/payout/service/request/' + rowId,
                method: 'GET',
                headers: {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (checkId && $.isNumeric(checkId)) {
                        $.ajax({
                            url: '/payout/topup/update/' + checkId,
                            method: 'GET',
                            data: {
                                requestType: type,
    ...
    $('#generateNewModule').on('click', function(event) {
        ...
        if (isValid) {
            var formData = $('#addpayout_fund').serialize();
            $.ajax({
                url: $('#addpayout_fund').attr('action'),
                type: 'POST',
                data: formData,
                success: function(response) {
