      ...
      <div class="navbar-header">
       ...
       <div class="user-image">
        <a class="navbar-brand" href="#">
          <img class="appxpay-top-nav-logo" src="{{asset('images/appxpay.png')}}" alt="appxpay"/>
        </a>
       </div>
      </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          @auth("merchantemp")
            ...
            <li class="dropdown">
                ...
                <li>
                    <p><label class="dropdown-label">Email:</label><a href="mailto:support@appxpay.co.in">support@appxpay.co.in</a></p>
                </li>
                <li>
