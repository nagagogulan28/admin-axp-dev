    ...
    <div class="navbar-header">
     ...
     <div class="user-image">
      <a class="navbar-brand" href="#">
        <img class="appxpay-top-nav-logo" src="{{asset('new/img/appxpay.png')}}" alt="appxpay logo"/>
      </a>
     </div>
    </div>
          ...
          <ul class="dropdown-menu-over list-unstyled">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><p><label class="dropdown-label">Email:</label><a href="mailto:support@appxpay.in">support@appxpay.in</a></p></li>
                    <li>
                    ...
                    <li><p><label class="dropdown-label">Contact:</label><a href="tel:+91 9087711911">+91 9087711911</a></p></li>
                    <li><p><label class="dropdown-label">Email:</label><a href="mailto:hello@appxpay.in">hello@appxpay.in</a></p></li>
                    <li>
                      <i class="fa fa-sign-out dropdown-icon">
                        <a class="test" href="{{ route('logout') }}"
