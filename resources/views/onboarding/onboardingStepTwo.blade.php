...
<div class="common-box onboarding-height-two">
    ...
    <div style="margin-top: 6rem !important;">
        {!! Form::open(['url' => '/onboarding/business', 'method' => 'post' , 'autocomplete' => 'off' , 'id' => 'steptwoform']) !!}
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                <div class="mb-5">
                    ...
                    {{ Form::text('account_holder_name',isset($user->businessDetail) && $user->businessDetail->account_holder_name != '' ? $user->businessDetail->account_holder_name : old('account_holder_name') , array( 'id' => 'accountholdernameinput' , 'class' => 'form-control splandnumberAvoid', 'placeholder' => 'Account Holder Name')) }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                <div class="mb-5">
                    {{Form::label('monthly_expenditure', 'Monthly Expenditure', array('class' => 'control-label'))}}
                    {{ Form::select('monthly_expenditure',
                        $monthlyExpenditure->pluck('option_value', 'id')->prepend('Select a Monthly Expenditure', ''), 
                        isset($user->businessDetail) && $user->businessDetail->monthly_expenditure != '' ? $user->businessDetail->monthly_expenditure : null,
                        ['class' => 'form-control', 'id' => 'monthlyexpenditureselect'])
                    }}
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                <div class="mb-5">
                    ...
                    {{ Form::text('city',isset($user->businessDetail) && $user->businessDetail->city != '' ? $user->businessDetail->city : old('city'), array( 'id' => 'cityinput', 'class' => 'form-control splandnumberAvoid', 'placeholder' => 'City')) }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                <div class="mb-5">
...
<script>
    $(document).ready(function() {
        ...
        var input = document.getElementById('banknameinput');
