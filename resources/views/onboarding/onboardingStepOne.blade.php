...
<div class="common-box onboarding-height">
    <div class="container-indicator">
        <section class="step-indicator">
            ...
            @php
            $get_level_three_1 = isset($user) && $currentLevel == 3 || isset($user) && $user->process_level >= 3 ? 'active' : '';
            $get_level_three_2 = isset($user) && $currentLevel == 3 || isset($user) && $user->process_level >= 3 ? 'in-complete' : '';
            @endphp
            ...
            @php
            $get_level_four_1 = isset($user) && $currentLevel == 4 || isset($user) && $user->process_level == 4 ? 'active' : '';
            $get_level_four_2 = isset($user) && $currentLevel == 4 || isset($user) && $user->process_level == 4 ? 'in-complete' : '';
            @endphp
    ...
    <div style="margin-top: 6rem !important;">
        {!! Form::open(['url' => '/onboarding/initial', 'method' => 'post' , 'autocomplete' => 'off']) !!}
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                <div class="mb-5">
                    ...
                    {{ Form::text('firstname', isset($user) ? $user->first_name : old('firstname'), ['id' => 'firstname-input', 'class' => 'form-control splandnumberAvoid', 'placeholder' => 'First Name']) }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                <div class="mb-5">
                    {{ Form::label('lastname', 'Last Name', ['class' => 'control-label']) }}
                    {{ Form::text('lastname', isset($user) ? $user->last_name : old('lastname'), ['id' => 'lastname-input', 'class' => 'form-control splandnumberAvoid', 'placeholder' => 'Last Name']) }}
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
                <div class="mb-5">
                    {{ Form::label('userName', 'User Name', ['class' => 'control-label']) }}
                    {{ Form::text('userName', isset($user) ? $user->user_name : old('userName'), ['class' => 'form-control splandAvoidUsername', 'placeholder' => 'User Name', 'autocomplete' => 'off']) }}
                </div>
            </div>        
            @if(!isset($user))
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-4">
