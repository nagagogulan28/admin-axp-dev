  ...
  <div id="invoice" class="effect2">
    <div id="invoice-top">
      <div class="logo">
          ...
          @else
          <img src="{{asset('assets/img/appxpay.png')}}" class="img-responsive" alt="appxpay" width="70px" height="60px">
          @endif
      </div>
      <div class="info">
        <h2>{{$inv_details['business_name']}}</h2>
        <p> hello@appxpay.in </br>
            +91 9087711911
        </p>
      </div><!--End Info-->
      <div class="title">
    ...
    <div id="invoice-bot">
      ...
      <div id="legalcopy">
        <p class="legal"><strong>Want to create invoice for your Business!</strong> Visit <span style="color: #178dbb;">appxpay.in/invoice</span> and get started instantly. 
        </p>
      </div>
                      ...
                      <div class="container course-payink-expiry">
                          <div class="row">
                              <div class="card-header">
                                  ...
                                  <h4 class="card-header-message">Thank you for using our appxpay Service</h4>
                              </div>
                          </div>
                          <div class="row">
                              <div class="card-body">
              ...
              <div class="row">
                  <div class="course-expiry">
                      <div class="container course-payink-expiry">
                          ...
                          <div class="row">
                              <div class="card-footer">
                                  <p>Powered by <span class="power"><a href="/">appxpay.in</a></span></p> 
                              </div>
                          </div>
                      </div>
                  </div>
