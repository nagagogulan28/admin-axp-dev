...
class Custom extends Model
{
    ...
    public function get_live_payment_info($ids){
        ...
        $query = "SELECT id, transaction_gid, vendor_transaction_id, bank_ref_no, order_id, transaction_response, transaction_method_id, transaction_type, transaction_email, transaction_contact, transaction_amount, transaction_status, transaction_mode, transaction_notes, transaction_description, appxpay_tax, goods_service_tax, android_status, adjustment_done,DATE_FORMAT(transaction_date,'%Y-%m-%d') as transaction_date, created_date, created_merchant, created_employee FROM live_payment
        WHERE $where_condition";
    ...
    public function get_appxpay_keys($merchant_id){
