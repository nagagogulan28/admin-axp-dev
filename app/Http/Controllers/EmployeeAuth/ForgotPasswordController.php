    ...
    */
    ...
    public function load_email_form(Request $request){
        ...
        $data = array(
            ...
            "subject"=>"appxpay Admin Password Reset",
    ...
    public function load_mobile_form(Request $request){
        ...
        $message = "Hi ".$employee->first_name." ".$employee->last_name.", Use this OTP ".wordwrap($OTP, 2 ,'-',true)." for changing appxpay account password. -appxpay";
    ...
    {
        if(str_ireplace("-","",$request->email_otp) == session('appxpay-email-verify'))
        {
    ...
    {
        if(str_ireplace("-","",$request->mobile_otp) == session('appxpay-mobile-verify'))
        {
