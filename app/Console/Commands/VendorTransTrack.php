...
class VendorTransTrack extends Command
{
     ...
     * @var string
     */
    protected $description = 'This command tracks appxpay transactions status with vendor paymentgatways';
    ...
    public function handle()
    {
        ...
        if(!empty($transactions))
        {
            ...
            if(!empty($appxpay_transtracking))
            {
                $trans_tracking = new appxpayTransTrack();
                $trans_tracking->add_trans_tracking($appxpay_transtracking);
            }
        }
    }
