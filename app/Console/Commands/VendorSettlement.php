...
class VendorSettlement extends Command 
{
     ...
     * @var string
     */
    protected $description = 'This command settles appxpay transaction amount with vendor paymentgatways';
    ...
    public function handle()
    {
        ...
        if(!empty($transactions))
        {
            ...
            if(!empty($appxpay_adjustment))
            {
                $adjustment = new appxpayAdjustment();
                $adjustment->add_adjustment($appxpay_adjustment);
            }
        }
